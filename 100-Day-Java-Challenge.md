...
*fundamentals → OOP → collections → concurrency → databases → Spring Boot → capstone.*
...
|:-----:|:----:|-------|-------------------|
| **1** | 1–10 | Environment, Syntax & Fundamentals | 🎲 Number Guessing Game + Grade Calculator |
| **2** | 11–20 | Methods & Procedural Problem Solving | 📚 Library Catalog (array-based) |
| **3** | 21–30 | OOP Fundamentals | 🏦 BankAccount / Customer System |
| **4** | 31–40 | Inheritance, Polymorphism & Abstraction | 🚗 Vehicle Rental System |
| **5** | 41–50 | Collections Framework & Generics | 📇 Contact Manager |
| **6** | 51–60 | Exceptions, I/O, Testing, Build Tools | 💰 CSV Expense Tracker (+ JUnit suite) |
| **7** | 61–70 | Functional Java & Streams | 📊 Stream-based Data Analytics Tool |
| **8** | 71–80 | Concurrency & Performance | ⬇️ Multithreaded File Downloader |
| **9** | 81–90 | Databases, Design Patterns & Architecture | ✅ Layered Task Management System |
